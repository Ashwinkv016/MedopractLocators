...
public class TC__003_ForgetPasswordTest extends CommonMethod {

	public TC__003_ForgetPasswordTest() throws Exception {
		super();
		// TODO Auto-generated constructor stub
	}

	Logger logger = LogManager.getLogger(TC__003_ForgetPasswordTest.class);
	...
	public void forgotpassword() throws Exception {
		...
		String actual = null;
		try {
			if (getWebElement("forgetPassPage").isDisplayed()) {
				actual = "success";
			} else {
				actual = "failure";
			}
