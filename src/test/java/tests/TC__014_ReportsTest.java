...
public class TC__014_ReportsTest extends CommonMethod{
	public TC__014_ReportsTest() throws Exception {
		super();
		// TODO Auto-generated constructor stub
	}
	Logger logger= LogManager.getLogger(TC__014_ReportsTest.class);
	...
	public void dateView() throws Exception{
		...
		String actual = getWebElement("reportsDate").getText();
