...
public class TC__004_HomePageAppointmentTest extends CommonMethod {

	public TC__004_HomePageAppointmentTest() throws Exception {
		super();
		// TODO Auto-generated constructor stub
	}

	Logger logger= LogManager.getLogger(TC__004_HomePageAppointmentTest.class);
	...
	public void addAppointmentWithoutData() throws Exception  {	
		...
		String actual = null;
		try {
			if(getWebElement("homePageAppErrorMsg").isDisplayed())
				actual="success";
		}
		catch(Exception e) {
			actual="failure";
