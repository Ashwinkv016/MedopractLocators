...
public class TC__009_AppointmentsCalenderTest extends CommonMethod {
	public TC__009_AppointmentsCalenderTest() throws Exception {
		super();
		// TODO Auto-generated constructor stub
	}

	Logger logger = LogManager.getLogger(TC__009_AppointmentsCalenderTest.class);
	...
	public void existingAppointmentInDay() throws Exception {
		...
		acp.getTodayButton();
		logger.info("Clicked on Today Btn");
		acp.getExistingAppointment1();
		logger.info("Clicked ExistingAppointment");
		acp.getcancelExistingAppointment();
		logger.info("Clicked Cancel ExistingAppointment");
