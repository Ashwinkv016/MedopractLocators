...
public class TC__006_AddPatientTest extends CommonMethod {
	public TC__006_AddPatientTest() throws Exception {
		super();
		// TODO Auto-generated constructor stub
	}

	Logger logger = LogManager.getLogger(TC__006_AddPatientTest.class);
